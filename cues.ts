...
export const CUE_SWITCH = require('./assets/audio/cues/switch.mp3');
...
export const CUE_NEXT: Record<string, number> = {
  ...
  'steam-engine': require('./assets/audio/cues/next-steam-engine.mp3'),
  'push-ups': require('./assets/audio/cues/next-push-ups.mp3'),
  crunches: require('./assets/audio/cues/next-crunches.mp3'),
  'hip-raises': require('./assets/audio/cues/next-hip-raises.mp3'),
  squats: require('./assets/audio/cues/next-squats.mp3'),
  'tricep-lifts': require('./assets/audio/cues/next-tricep-lifts.mp3'),
